...
In this project, I experimented with LEDs. In the end, my ultimate product was a 24x8 LED Matrix. By using the code provided in the finalMatrix folder, the LED Matrix can display any text received via serial, with the option of having the text scroll from right to left on the matrix. The matrix was built using shift registers and the Persistence of Version (POV) effect.
